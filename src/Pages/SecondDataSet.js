...
export default function Chart({}) {
  ...
  useEffect(() => {
    d3.csv(
      "https://raw.githubusercontent.com/Adam-Shaka/Testing-.csv/main/all%20results%20second%20time%20period2.csv",
      function (d) {
        return {
  ...
  return (
    <div>
      <h1>Data from the 14/08/23 - 21/12/23</h1>
      <text>
